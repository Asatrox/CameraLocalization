...
from src.layers.vision_transformer import vit_large
from src.layers.rope import RotaryPositionEmbedding2D, PositionGetter
...
if __name__ == "__main__":
    ...
    missing = model.load_state_dict(state_dict)
    model.to(device)
